...
$ticketDiscountQuantity = 2;
$ticketGroupPrice = 800;
$ticketGroupQuantity = 3;

$barcode = $orderService->bookOrder($eventId, $eventDate, $ticketAdultPrice, $ticketAdultQuantity, $ticketKidPrice, $ticketKidQuantity, $ticketDiscountPrice, $ticketDiscountQuantity, $ticketGroupPrice, $ticketGroupQuantity);
